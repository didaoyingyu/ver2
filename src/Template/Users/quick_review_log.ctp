<div class="row">
	<h3 class="col-md-12">Complete Log</h3>
</div>
...
<div class="row">
	...
	<input type="button" value="Filter" class="btn btn-primary col-md-2" id="filterLog" />
</div>
...
<div class="row" style="margin-top:10px;">
	<table class="table table-striped table-bordered table-responsive">
		...
		<tbody>
			...
			<?php else : ?>
			<tr>
				<td colspan=18 style="text-align:center;">No Logs found.</td>
			</tr>
			<?php endif; ?>
		</tbody>
	</table>
